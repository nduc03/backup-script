...
if [ "$color_prompt" = yes ]; then
    PS1='${debian_chroot:+($debian_chroot)}\[\033[01;32m\]\u@MácBúc-Pờrô\[\033[00m\] \[\033[01;34m\]\w\[\033[00m\] % '
    # PS1='${debian_chroot:+($debian_chroot)}\[\033[01;32m\]\u@\h\[\033[00m\]:\[\033[01;34m\]\w\[\033[00m\]\$ '
else
    PS1='${debian_chroot:+($debian_chroot)}\u@MácBúc-Pờrô\ \w\ % '
...
echo -e "Kernel: \033[0;32m$(uname)\033[0m, version: \033[0;32m$(uname -r)\033[0m"
echo -e "Current time: \033[0;32m$(date +"%d/%m/%Y %H:%M:%S")\033[0m"
echo -e "System Uptime: \033[0;32m$(uptime -p)\033[0m"
echo ""
echo -e "Hello \033[01;32m$(whoami)\033[00m!"
